...
export const COLORS = {
  ...
  teacherPalette: {
    ...
    neutral: {
      ...
      medium: '#D1D5DB', // Medium gray - secondary text 
  ...
  background: {
    ...
    secondary: '#F8F9FA',
    landing: '#155677',
    landingGradient: ['#419ac7ff', '#346f88ff'],
  },
...
export const TEACHER_THEME = {
  ...
  typography: {
    h1: {
      fontSize: 28,
      fontWeight: '700',
      color: COLORS.teacherPalette.text.primary,
    },
    h2: {
      fontSize: 24,
      fontWeight: '600',
    ...
    caption: {
      fontSize: 14,
      fontWeight: '400',
      color: COLORS.teacherPalette.text.secondary,
    },
    small: {
      fontSize: 12,
      fontWeight: '400',
      color: COLORS.teacherPalette.text.muted,
    },
  },
};
