...
const SignUpScreen = ({ route }) => {
  ...
  // Get signup type from route params (platform or visitor)
  const initialSignupType = route.params?.signupType || 'platform';
  ...
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    role: signupType === 'platform' ? '' : USER_ROLES.VISITOR,
  });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const signupPayload = {
        ...
        role: signupType === 'platform' ? formData.role : USER_ROLES.VISITOR,
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.signupTypeContainer}>
          <TouchableOpacity
            style={[
              ...
              signupType === 'platform' && styles.signupTypeActive,
            ]}
            onPress={() => setSignupType('platform')}
          >
            <Text
              style={[
                styles.signupTypeText,
                signupType === 'platform' && styles.signupTypeTextActive,
              ]}
            >
              Platform User
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.signupTypeButton,
              signupType === 'visitor' && styles.signupTypeActive,
            ]}
            onPress={() => setSignupType('visitor')}
          >
            <Text
              style={[
                styles.signupTypeText,
                signupType === 'visitor' && styles.signupTypeTextActive,
              ]}
            >
              Visitor
            </Text>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.form}>
              ...
              <View style={styles.inputGroup}>
                ...
                >
                  <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.4)', justifyContent: 'center', alignItems: 'center' }}>
                    <View style={{ backgroundColor: '#fff', borderRadius: 12, padding: 24, minWidth: 250 }}>
                      ...
                      <TouchableOpacity style={{ paddingVertical: 12, alignItems: 'center', marginTop: 8 }} onPress={() => setShowRolePicker(false)}>
                        <Text style={{ fontSize: 16, color: '#E74C3C', fontWeight: 'bold' }}>Cancel</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                </Modal>
            ...
            {/* Login Link with Platform/Visitor options and improved layout */}
            <View
              style={[
                styles.linkContainer,
                { flexDirection: 'column', alignItems: 'center', marginTop: 8 },
              ]}
            >
              <Text style={styles.linkText}>Already have an account?</Text>
              <View style={{ flexDirection: 'row', marginTop: 8 }}>
                <TouchableOpacity
                  style={[styles.loginTypeButton, { marginRight: 8 }]}
                  onPress={() =>
                    navigation.navigate('Login', { loginType: 'platform' })
                  }
                  disabled={loading || googleLoading}
                >
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    navigation.navigate('Login', { loginType: 'visitor' })
                  }
                  disabled={loading || googleLoading}
                >
            ...
            {/* Removed 'Sign up as:' platform/visitor links as requested */}
          </View>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
...
//       } else if (error.message.includes('phone number')) {
//         errorMessage =
//           'Please enter a valid phone number (e.g., 01888227599 or +8801888227599)';
//       } else if (error.message.includes('validation')) {
//         errorMessage = 'Please check your input and try again.';
//       } else if (
